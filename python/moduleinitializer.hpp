...
private:
    ...
    // logging is wired up via generic pybind11::object + module::import/
    // getattr calls rather than a typed binding. nanobind's nb::object/
    // nb::module_ offer equivalent but differently-named methods.
...
#endif // PYTHON_MODULEINITIALIZER_HPP
